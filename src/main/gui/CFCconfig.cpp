...
void CFCconfig::setOptions() {
    ...
    ui.lineEdit_6->setText(QString::number(config->monitorIntervals[0]));
    ui.lineEdit_7->setText(QString::number(config->monitorIntervals[1]));
...
void CFCconfig::syncOptions() {
    ...
    config->monitorIntervals[0]=ui.lineEdit_6->text().toInt();
    config->monitorIntervals[1]=ui.lineEdit_7->text().toInt();
